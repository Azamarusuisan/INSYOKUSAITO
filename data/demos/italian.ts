    ...
    categories: [
      {
        ...
        isPublished: true,
        items: pub([
          { id: "caprese", name: "水牛モッツァレラのカプレーゼ", subName: "Caprese di Bufala", price: 1480, description: "完熟トマトと水牛モッツァレラ、バジル。", badge: "定番", tags: ["ベジタリアン", "定番"] },
          { id: "prosciutto", name: "生ハムとメロン", subName: "Prosciutto e Melone", price: 1680, description: "パルマ産プロシュート18ヶ月熟成。", tags: ["肉"] },
          { id: "bruschetta", name: "ブルスケッタ三種盛り", subName: "Bruschette Miste", price: 1280, tags: ["ベジタリアン"] },
          { id: "carpaccio", name: "真鯛のカルパッチョ", subName: "Carpaccio di Orata", price: 1580, description: "瀬戸内産真鯛と柑橘、ケッパー。", tags: ["魚介"] },
        ]),
      },
      {
        id: "pasta",
        ...
        items: pub([
          ...
          { id: "vongole", name: "ボンゴレ ビアンコ", subName: "Spaghetti alle Vongole", price: 1980, description: "活アサリと白ワイン。", tags: ["魚介"] },
          { id: "ragu", name: "牛ほほ肉のラグー", subName: "Tagliatelle al Ragù", price: 2080, description: "8時間煮込みの自家製麺。", badge: "シェフ推薦", tags: ["肉", "おすすめ"] },
        ]),
      },
      {
        id: "pizza",
        ...
        items: pub([
          ...
          { id: "quattro", name: "クアトロフォルマッジ", subName: "Quattro Formaggi", price: 2280, description: "蜂蜜を添えて。", tags: ["ベジタリアン", "チーズ"] },
        ]),
      },
      {
        id: "dolce",
        ...
        isPublished: true,
        items: pub([
          { id: "tiramisu", name: "自家製ティラミス", subName: "Tiramisù", price: 880, badge: "人気", tags: ["人気", "ベジタリアン"] },
          { id: "pannacotta", name: "パンナコッタ ベリーソース", subName: "Panna Cotta", price: 780, tags: ["ベジタリアン"] },
        ]),
      },
    ],
  },
